        ...
        EditorGUI.BeginProperty(position, GUIContent.none, property);
        {
            ...
            // Optional: Indent the content
                ...
                EditorGUI.BeginChangeCheck();
                {
                    ...
                    sceneAssetProperty.objectReferenceValue = EditorGUI.ObjectField(position, sceneAssetProperty.objectReferenceValue,
    ...
    private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
    {
        ...
        using (new EditorGUI.DisabledScope(readOnly))
        {
            ...
            if (buildScene.buildIndex == -1)
            {
                ...
                if (DrawUtils.ButtonHelper(buttonRect, "Add...", "Add (buildIndex " + addIndex + ")", EditorStyles.miniButtonLeft,
                    tooltipMsg))
